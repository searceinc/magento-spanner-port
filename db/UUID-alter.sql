...
CREATE TABLE quote_item (
    ...
    weight FLOAT64,                                -- From: weight decimal(12,4)
    qty FLOAT64 NOT NULL,                          -- From: qty decimal(12,4)
    price FLOAT64 NOT NULL,                        -- From: price decimal(12,4)
    base_price FLOAT64 NOT NULL,                   -- From: base_price decimal(12,4)
    custom_price FLOAT64,                          -- From: custom_price decimal(12,4)
    discount_percent FLOAT64,                      -- From: discount_percent decimal(12,4)
    discount_amount FLOAT64,                       -- From: discount_amount decimal(20,4)
    base_discount_amount FLOAT64,                  -- From: base_discount_amount decimal(20,4)
    tax_percent FLOAT64,                           -- From: tax_percent decimal(12,4)
    tax_amount FLOAT64,                            -- From: tax_amount decimal(20,4)
    base_tax_amount FLOAT64,                       -- From: base_tax_amount decimal(20,4)
    row_total FLOAT64 NOT NULL,                    -- From: row_total decimal(20,4)
    base_row_total FLOAT64 NOT NULL,               -- From: base_row_total decimal(20,4)
    row_total_with_discount FLOAT64,               -- From: row_total_with_discount decimal(20,4)
    row_weight FLOAT64,                            -- From: row_weight decimal(12,4)
    product_type STRING(255),                      -- From: product_type varchar(255)
    base_tax_before_discount FLOAT64,              -- From: base_tax_before_discount decimal(20,4)
    tax_before_discount FLOAT64,                   -- From: tax_before_discount decimal(20,4)
    original_custom_price FLOAT64,                 -- From: original_custom_price decimal(12,4)
    redirect_url STRING(255),                      -- From: redirect_url varchar(255)
    base_cost FLOAT64,                             -- From: base_cost decimal(12,4)
    price_incl_tax FLOAT64,                        -- From: price_incl_tax decimal(20,4)
    base_price_incl_tax FLOAT64,                   -- From: base_price_incl_tax decimal(20,4)
    row_total_incl_tax FLOAT64,                    -- From: row_total_incl_tax decimal(20,4)
    base_row_total_incl_tax FLOAT64,               -- From: base_row_total_incl_tax decimal(20,4)
    discount_tax_compensation_amount FLOAT64,      -- From: discount_tax_compensation_amount decimal(20,4)
    base_discount_tax_compensation_amount FLOAT64, -- From: base_discount_tax_compensation_amount decimal(20,4)
    weee_tax_applied STRING(MAX),                  -- From: weee_tax_applied text
    weee_tax_applied_amount FLOAT64,               -- From: weee_tax_applied_amount decimal(12,4)
    weee_tax_applied_row_amount FLOAT64,           -- From: weee_tax_applied_row_amount decimal(12,4)
    weee_tax_disposition FLOAT64,                  -- From: weee_tax_disposition decimal(12,4)
    weee_tax_row_disposition FLOAT64,              -- From: weee_tax_row_disposition decimal(12,4)
    base_weee_tax_applied_amount FLOAT64,          -- From: base_weee_tax_applied_amount decimal(12,4)
    base_weee_tax_applied_row_amnt FLOAT64,        -- From: base_weee_tax_applied_row_amnt decimal(12,4)
    base_weee_tax_disposition FLOAT64,             -- From: base_weee_tax_disposition decimal(12,4)
    base_weee_tax_row_disposition FLOAT64,         -- From: base_weee_tax_row_disposition decimal(12,4)
...
CREATE TABLE quote_address (
    ...
    weight FLOAT64,                              -- From: weight decimal(12,4)
    subtotal FLOAT64 NOT NULL,                            -- From: subtotal decimal(20,4)
    base_subtotal FLOAT64 NOT NULL,                       -- From: base_subtotal decimal(20,4)
    subtotal_with_discount FLOAT64 NOT NULL,              -- From: subtotal_with_discount decimal(20,4)
    base_subtotal_with_discount FLOAT64 NOT NULL,         -- From: base_subtotal_with_discount decimal(20,4)
    tax_amount FLOAT64 NOT NULL,                          -- From: tax_amount decimal(20,4)
    base_tax_amount FLOAT64 NOT NULL,                     -- From: base_tax_amount decimal(20,4)
    shipping_amount FLOAT64 NOT NULL,                     -- From: shipping_amount decimal(20,4)
    base_shipping_amount FLOAT64 NOT NULL,                -- From: base_shipping_amount decimal(20,4)
    shipping_tax_amount FLOAT64,                          -- From: shipping_tax_amount decimal(20,4)
    base_shipping_tax_amount FLOAT64,                     -- From: base_shipping_tax_amount decimal(20,4)
    discount_amount FLOAT64 NOT NULL,                     -- From: discount_amount decimal(20,4)
    base_discount_amount FLOAT64 NOT NULL,                -- From: base_discount_amount decimal(20,4)
    grand_total FLOAT64 NOT NULL,                         -- From: grand_total decimal(20,4)
    base_grand_total FLOAT64 NOT NULL,                    -- From: base_grand_total decimal(20,4)
    ...
    shipping_discount_amount FLOAT64,                     -- From: shipping_discount_amount decimal(20,4)
    base_shipping_discount_amount FLOAT64,                -- From: base_shipping_discount_amount decimal(20,4)
    subtotal_incl_tax FLOAT64,                            -- From: subtotal_incl_tax decimal(20,4)
    base_subtotal_total_incl_tax FLOAT64,                 -- From: base_subtotal_total_incl_tax decimal(20,4)
    discount_tax_compensation_amount FLOAT64,             -- From: discount_tax_compensation_amount decimal(20,4)
    base_discount_tax_compensation_amount FLOAT64,        -- From: base_discount_tax_compensation_amount decimal(20,4)
    shipping_discount_tax_compensation_amount FLOAT64,    -- From: shipping_discount_tax_compensation_amount decimal(20,4)
    base_shipping_discount_tax_compensation_amnt FLOAT64, -- From: base_shipping_discount_tax_compensation_amnt decimal(20,4)
    shipping_incl_tax FLOAT64,                            -- From: shipping_incl_tax decimal(20,4)
    base_shipping_incl_tax FLOAT64,                       -- From: base_shipping_incl_tax decimal(20,4)
...
CREATE TABLE quote_address_item (
    ...
    price FLOAT64,                                 -- From: price decimal(12,4)
    discount_percent FLOAT64,                      -- From: discount_percent decimal(12,4)
    no_discount INT64,                             -- From: no_discount int(11)
    tax_percent FLOAT64,                           -- From: tax_percent decimal(12,4)
    base_price FLOAT64,                            -- From: base_price decimal(12,4)
    base_cost FLOAT64,                             -- From: base_cost decimal(12,4)
    price_incl_tax FLOAT64,                        -- From: price_incl_tax decimal(20,4)
    base_price_incl_tax FLOAT64,                   -- From: base_price_incl_tax decimal(20,4)
    row_total_incl_tax FLOAT64,                    -- From: row_total_incl_tax decimal(20,4)
